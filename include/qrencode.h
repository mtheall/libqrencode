 ...
 */
QR_API QRinput *QRinput_new(void);
 ...
 */
QR_API QRinput *QRinput_new2(int version, QRecLevel level);
 ...
 * @throw EINVAL invalid arguments.
 */
QR_API QRinput *QRinput_newMQR(int version, QRecLevel level);
 ...
 *
 */
QR_API int QRinput_append(QRinput *input, QRencodeMode mode, int size, const unsigned char *data);
 ...
 *
 */
QR_API int QRinput_appendECIheader(QRinput *input, unsigned int ecinum);
 ...
 */
QR_API int QRinput_getVersion(QRinput *input);
 ...
 */
QR_API int QRinput_setVersion(QRinput *input, int version);
 ...
 */
QR_API QRecLevel QRinput_getErrorCorrectionLevel(QRinput *input);
 ...
 * @retval -1 invalid argument.
 */
QR_API int QRinput_setErrorCorrectionLevel(QRinput *input, QRecLevel level);
 ...
 * @retval -1 invalid argument.
 */
QR_API int QRinput_setVersionAndErrorCorrectionLevel(QRinput *input, int version, QRecLevel level);
 ...
 * @param input input object.
 */
QR_API void QRinput_free(QRinput *input);
 ...
 */
QR_API int QRinput_check(QRencodeMode mode, int size, const unsigned char *data);
 ...
 * @throw ENOMEM unable to allocate memory.
 */
QR_API QRinput_Struct *QRinput_Struct_new(void);
 ...
 */
QR_API void QRinput_Struct_setParity(QRinput_Struct *s, unsigned char parity);
 ...
 * @throw EINVAL invalid arguments.
 */
QR_API int QRinput_Struct_appendInput(QRinput_Struct *s, QRinput *input);

/**
 * Free all of QRinput in the set.
 * @param s a structured input object.
 */
QR_API void QRinput_Struct_free(QRinput_Struct *s);
 ...
 * @throw ENOMEM unable to allocate memory.
 */
QR_API QRinput_Struct *QRinput_splitQRinputToStruct(QRinput *input);
 ...
 * @throw ENOMEM unable to allocate memory.
 */
QR_API int QRinput_Struct_insertStructuredAppendHeaders(QRinput_Struct *s);

/**
 * Set FNC1-1st position flag.
 */
QR_API int QRinput_setFNC1First(QRinput *input);

/**
 * Set FNC1-2nd position flag and application identifier.
 */
QR_API int QRinput_setFNC1Second(QRinput *input, unsigned char appid);
 ...
 * @throw ENOMEM unable to allocate memory for input objects.
 */
QR_API QRcode *QRcode_encodeInput(QRinput *input);
 ...
 * @throw ERANGE input data is too large.
 */
QR_API QRcode *QRcode_encodeString(const char *string, int version, QRecLevel level, QRencodeMode hint, int casesensitive);

/**
 * Same to QRcode_encodeString(), but encode whole data in 8-bit mode.
 * @warning This function is THREAD UNSAFE when pthread is disabled.
 */
QR_API QRcode *QRcode_encodeString8bit(const char *string, int version, QRecLevel level);

/**
 * Micro QR Code version of QRcode_encodeString().
 * @warning This function is THREAD UNSAFE when pthread is disabled.
 */
QR_API QRcode *QRcode_encodeStringMQR(const char *string, int version, QRecLevel level, QRencodeMode hint, int casesensitive);

/**
 * Micro QR Code version of QRcode_encodeString8bit().
 * @warning This function is THREAD UNSAFE when pthread is disabled.
 */
QR_API QRcode *QRcode_encodeString8bitMQR(const char *string, int version, QRecLevel level);
 ...
 * @throw ERANGE input data is too large.
 */
QR_API QRcode *QRcode_encodeData(int size, const unsigned char *data, int version, QRecLevel level);

/**
 * Micro QR Code version of QRcode_encodeData().
 * @warning This function is THREAD UNSAFE when pthread is disabled.
 */
QR_API QRcode *QRcode_encodeDataMQR(int size, const unsigned char *data, int version, QRecLevel level);

/**
 * Free the instance of QRcode class.
 * @param qrcode an instance of QRcode class.
 */
QR_API void QRcode_free(QRcode *qrcode);
 ...
 */
QR_API QRcode_List *QRcode_encodeInputStructured(QRinput_Struct *s);
 ...
 * @throw ENOMEM unable to allocate memory for input objects.
 */
QR_API QRcode_List *QRcode_encodeStringStructured(const char *string, int version, QRecLevel level, QRencodeMode hint, int casesensitive);

/**
 * Same to QRcode_encodeStringStructured(), but encode whole data in 8-bit mode.
 * @warning This function is THREAD UNSAFE when pthread is disabled.
 */
QR_API QRcode_List *QRcode_encodeString8bitStructured(const char *string, int version, QRecLevel level);
 ...
 * @throw ENOMEM unable to allocate memory for input objects.
 */
QR_API QRcode_List *QRcode_encodeDataStructured(int size, const unsigned char *data, int version, QRecLevel level);
 ...
 */
QR_API int QRcode_List_size(QRcode_List *qrlist);

/**
 * Free the QRcode_List.
 * @param qrlist a head entry of a QRcode_List.
 */
QR_API void QRcode_List_free(QRcode_List *qrlist);
 ...
 * @param micro_version
 */
QR_API void QRcode_APIVersion(int *major_version, int *minor_version, int *micro_version);
 ...
 */
QR_API char *QRcode_APIVersionString(void);
 ...
 */
QR_API void QRcode_clearCache(void);
